...
export const TEXT_AREA_VARIANTS = tv({
  ...
  variants: {
    ...
    size: {
      sm: clsx("mg-text-sm mg-leading-sm", "mg-p-3"),
      md: clsx("mg-text-md mg-leading-md", "mg-px-3 mg-py-4"),
    },
    error: {
    ...
    resize: {
      both: clsx("mg-resize"),
      horizontal: clsx("mg-resize-x"),
      vertical: clsx("mg-resize-y"),
      none: clsx("mg-resize-none"),
    },
  },
});
